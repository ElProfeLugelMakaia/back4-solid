...
public class Main {
    ...
    public static void main(String[] args) {
        while (true) {
            double opcion = getDoublePorConsola("Ingrese la operación que desea ejecutar: " +
                    "\n 1. singleResponsability.Suma " +
                    "\n 2. resta " +
                    "\n 3. singleResponsability.Multiplicacion" +
                    "\n 4. División");
    ...
    public static void ejecutarOperacion(Calculadora calculadora, int opcion) {
        ...
        /**switch (opcion) {
            case 1:
                singleResponsability.Suma s = new singleResponsability.Suma(4, 5);
